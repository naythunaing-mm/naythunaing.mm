        ...
        <div className=" py-10 min-w-full max-w-screen-md items-center md:max-w-xl dark:bg-gray-900">
            <div className="flex px-2 sm:px-6 lg:px-8 justify-center items-center">
                ...
                <div className="px-2 md:px-8 lg:px-4 overflow-x-auto">
                    ...
                    <svg
                        className="w-3 h-3 md:w-10 md:h-10 mx-auto mb-2 text-gray-400 dark:text-gray-600"
                        aria-hidden="true"
                    ...
                    <figcaption className="flex items-center justify-center mt-6 space-x-3 rtl:space-x-reverse">
                        ...
                        <cite className="pe-3 text-xs md:text-2xl lg:text-2xl font-medium text-gray-900 dark:text-white text-nowrap">
                            {name}
                        </cite>
                        <cite className="ps-3 text-xs md:text-2xl lg:text-2xl text-gray-500 dark:text-gray-400">
                            {position}
                        </cite>
                        </div>
                    </figcaption>
