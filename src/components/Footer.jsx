                ...
                <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <a href="https://github.com/naythunaing-mm" className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                            <img src="https://github.com/naythunaing-mm" className="h-8" alt="Flowbite Logo" />
                    ...
                    <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© {new Date().getFullYear()} <a href="https://github.com/naythunaing-mm" className="hover:underline">Nay Thu Naing</a>. All Rights Reserved.</span>
                </div>
            </footer>
